...
void Extract (struct UserPrivateKey * sk, struct PublicKey * PK, struct MasterSecertKey * msk);
...
void Decrypt(struct TransformationKey * TK, struct PartialDecryptionCiphertext * CTp, pairing_t pairing);
